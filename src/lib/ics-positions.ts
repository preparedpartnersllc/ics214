export const ICS_POSITIONS = [
  ...
  { section: 'Operations Section', label: 'Division Supervisor', value: 'division_supervisor' },
  { section: 'Operations Section', label: 'Division/Group Supervisor', value: 'division_group_supervisor' },
  { section: 'Operations Section', label: 'Group Supervisor', value: 'group_supervisor' },
  { section: 'Operations Section', label: 'Air Operations Branch Director', value: 'air_ops_branch_director' },
  { section: 'Operations Section', label: 'Team Leader', value: 'team_leader' },
